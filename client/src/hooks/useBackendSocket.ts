 ...
 *
 * This Hook encapsulates all of the logic required to subscribe to a particular event emitted over a particular socket namespace and maintain an internal state based on the actions transmitted.
...
export default function<IState, IEvent>(
  ...
  useSocketSubscribe(io, room, listener);
